...
class _ExploreScreenState extends State<ExploreScreen>
  ...
  List<FindProductModel> _products = [
    FindProductModel(
        PNGs.imgDogItem2Clear, 'Happy Dog', Color(0xFF53B175)),
    FindProductModel(
        PNGs.imgDogItem1Clear, 'Cry Dog', Color(0xFFF8A44C)),
    FindProductModel(PNGs.imgDogItem3Clear, 'Brave Dog', Color(0xFFF7A593)),
    FindProductModel(
        PNGs.imgDogItem4Clear, 'Sad Dog', Color(0xFFD3B0E0)),
    FindProductModel(PNGs.imgDogItem5Clear, 'Embarrassed Dog', Color(0xFFFDE598)),
    FindProductModel(PNGs.imgDogItem6Clear, 'Love-struck Dog', Color(0xFFB7DFF5)),
  ];
