...
class _ExploreSelectedProductListState extends State<ExploreSelectedProductList>
  ...
  List<ProductModel> _products = [
    ProductModel(PNGs.imgDog1, 'Happy Dog', '7pcs', '\$4.99'),
    ProductModel(PNGs.imgDog2, 'Happy Dog', '7pcs', '\$4.99'),
    ProductModel(PNGs.imgDog3, 'Happy Dog', '7pcs', '\$4.99'),
    ProductModel(PNGs.imgDog4, 'Happy Dog', '7pcs', '\$4.99'),
    ProductModel(PNGs.imgDog5, 'Happy Dog', '7pcs', '\$4.99'),
    ProductModel(PNGs.imgDog6, 'Happy Dog', '7pcs', '\$4.99'),
  ];
